...
const Firstpage = () => {
  return (
    <div className={home.v1_2}>
      ...
      <Link to="/fourth"><span className={home.v1_7}>Final Race</span></Link>
      <Link to="/leader"><span className={home.v1_8}>Leader boards</span></Link>
      <Link to="/aboutpage"><span className={home.v1_9}>About</span></Link>
      <Link to="/contactpage"><span className={home.v1_10}>Contact</span></Link>
      <div className={home.v1_11} />

      <div className={home.v1_15}>
      <Link to="/loginpage"><span className={home.v1_16}>Sign in</span></Link>
